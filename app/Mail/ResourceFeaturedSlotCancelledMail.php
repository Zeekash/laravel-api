...
class ResourceFeaturedSlotCancelledMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->subject($this->isAdmin
                ? "Resource Featured Slot Cancelled - {$companyName}"
                : "Your Resource Featured Slot Cancellation")
            ->view('emails.resource-featured-ads.cancelled')
            ->with([
