...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('city_to_city_move_size_costs', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('city_to_city_route_id');
            $table->foreign('city_to_city_route_id')->references('id')->on('city_to_city_routes')->onDelete('cascade');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('city_to_city_move_size_costs');
    }
};
