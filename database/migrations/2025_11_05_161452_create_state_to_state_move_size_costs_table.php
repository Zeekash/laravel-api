...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('state_to_state_move_size_costs', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('state_to_state_route_id');
            $table->foreign('state_to_state_route_id')->references('id')->on('state_to_state_routes')->onDelete('cascade');
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('state_to_state_move_size_costs');
    }
};
