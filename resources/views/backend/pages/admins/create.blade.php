                    ...
                    <form action="{{ route('admin.admins.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 col-sm-6">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="username" name="username" placeholder="Enter Username">
                            </div>
                             <div class="form-group col-md-6 col-sm-6">
                                <label for="username">Author Description</label>
                                <textarea type="text" class="form-control " id="username" name="description" placeholder="Author Description..."></textarea>
                            </div>
                        </div>
