...
@section('title', 'Best State Top Mover Create')
        ...
        <div class="col-lg-12 col-ml-12">
            <div class="row">
                <div class="col-12 mt-5">
                    ...
                    <form action="{{ route('admin.best-state.top-mover.store') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                <div class="card-head">
                                    <h4 class="header-title">Best State Top Mover Create</h4>
                                </div>
                                <div class="row">
