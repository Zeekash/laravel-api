    ...
    <div class="invoice">
        <div class="inv-head">
            ...
            <div style="text-align:right">
                <h2 style="margin:0">City Featured Ads Invoice</h2>
        ...
        <div class="details">
            ...
            <div class="box">
                <strong>City Slot</strong><br>
                {{ optional(optional($invoice->subscription)->cityPage)->name ?? 'City' }}@if(optional(optional(optional($invoice->subscription)->cityPage)->state)->abv), {{ optional(optional(optional($invoice->subscription)->cityPage)->state)->abv }}@endif<br>
