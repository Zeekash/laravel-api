    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                ...
                <h4 class="page-title pull-left">Company Info</h4>
                <ul class="breadcrumbs pull-left">
                    <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li><span>Company Infos</span></li>
                </ul>
            </div>
        </div>
...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left">Company Infos</h4>
                    ...
                    <div class="data-tables">
                        ...
                        <table id="dataTable" class="text-center table-responsive-lg">
                            ...
                            @foreach ($company_info as $companyInfo)
                            
                            <tr> 
                                <td><input type="checkbox" class="sub_chk" data-id="{{$companyInfo->id}}"></td>
                                <td>{{ $loop->index+1}}</td>
                                <td>{{ $companyInfo->company->company_name }}</td>
                                <td style="display:flex;justify-content: center">
                                      <a class="btn btn-primary text-white" href="{{route('admin.company-info.show', $companyInfo->id)}}"><i class="fa fa-eye"></i></a>                           
                                    <form method="POST" action="{{ route('admin.company-info.destroy', $companyInfo->id) }}">
                                        @csrf
