...
<div class="main-content-inner">
    <div class="row">
        ...
        <div class="col-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title float-left">All Queries</h4>
                    <div class="clearfix"></div>
                    @if ($user->can('contact-us.delete'))
                    ...
                    <div class="data-tables">
                        ...
                        <table id="dataTable" class="text-center table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    @if ($user->can('contact-us.delete'))
                                    <td><input type="checkbox" class="sub_chk" data-id="{{$contact_us->id}}"></td>
                                    @endif
                                    <td>{{ $loop->index+1}}</td>
                                    <td>{{ $contact_us->company->company_name }}</td>
                                    <td>{{ $contact_us->subject }}</td>
                                    <td>{{ $contact_us->description }}</td>
                                    <td style="display:flex;justify-content: center">
                                        <a class="btn btn-primary text-white" href="{{route('admin.contact-us.show', $contact_us->id)}}"><i class="fa fa-eye"></i></a>
                                        @if ($user->can('contact-us.delete'))                          
                                        <form method="POST" action="{{ route('admin.contact-us.destroy', $contact_us->id) }}">
                                            @csrf
