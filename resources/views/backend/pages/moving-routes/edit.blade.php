            ...
            <div class="row">
                ...
                <div class="col-12 mt-5">
                    ...
                    @if (Session::has('success'))
                        <div class="alert alert-success alert-dimissable fade show mx-auto" style="15%"
                            id="hide-msg">
                    ...
                    @if (Session::has('error'))
                        <div class="alert alert-danger alert-dimissable fade show mx-auto" style="15%"
                            id="hide-msg">
                            <i class="fa fa-times-circle"></i>
                    ...
                    <form action="{{ route('admin.moving-route.update', $movingRoute->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $movingRoute->meta_title }}"
                                    ...
                                    <div class="col-lg-8 col-12">
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Meta
                                                Description</label>
                                            <input type="text" value="{{ $movingRoute->meta_description }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $movingRoute->title }}" name="title"
                                                class="form-control">
                                    ...
                                    <div class="col-lg-8 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $movingRoute->slug }}" name="slug"
                                                class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="upper_content" rows="10" cols="30" class="form-control" id="upper" required>{{ $movingRoute->upper_content }}</textarea>
                                    ...
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="lower_content" rows="10" cols="30" class="form-control" id="lower" required>{{ $movingRoute->lower_content }}</textarea>
