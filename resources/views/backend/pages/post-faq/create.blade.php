    ...
    <div class="main-content-inner">
        <div class="row">
            ...
            <div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title">Create Post Faq</h4>
                        @include('backend.layouts.partials.messages')

                        <form action="{{ route('admin.post-faq.store') }}" method="POST">
                            @csrf
                            <div class="table-responsive">
                                <table class="table">
                                    <tbody>
                                        <tr id="initialRow">
                                            <td class="col-md-3">
                                                <select name="inputs[0][post_id]" id="postSelect" class="form-control">
    ...
    <script>
        $(document).ready(function() {
            ...
            function addRow() {
                ...
                <tr>
                    <td>
                        <input type="hidden" name="inputs[${rowCounter}][post_id]" value="${$('#postSelect').val()}">
