                    ...
                    <form action="{{ route('admin.products.update',$product->id) }}" method="POST" >
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" placeholder="Enter Name" value="{{ $product->name }}">
                            @error('name')
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input type="number" class="form-control @error('price') is-invalid @enderror" id="price" name="price" placeholder="Enter Price" value="{{ $product->price }}">
                            @error('price')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
