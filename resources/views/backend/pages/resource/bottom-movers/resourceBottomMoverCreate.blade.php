...
@section('title','Resource Bottom Mover Create')
        ...
        <div class="col-lg-12 col-ml-12">
            <div class="row">
                ...
                <div class="col-12 mt-5">
                    ...
                    <h4 class="header-title">Resource Bottom Mover - Create</h4>
                    @include('flash-message')
                    <form action="{{ route('admin.resource.bottom.mover.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card mt-4">
                            <div class="card-body">
                                <div class="card-head">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="content" rows="10" cols="30" class="form-control" id="mytextarea"></textarea>
                                        </div>
                                    </div>
                                </div>
