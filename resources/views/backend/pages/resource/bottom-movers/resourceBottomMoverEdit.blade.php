...
@section('title','Resource Bottom Mover Edit')
        ...
        <div class="col-lg-12 col-ml-12">
            <div class="row">
                ...
                <div class="col-12 mt-5">
                    <a href="{{ route('admin.resource.bottom.mover.index') }}" class="btn btn-primary float-right "> Back</a>
                    <h4 class="header-title">Resource Bottom Mover - Edit</h4>
                    @include('flash-message')
                    <form action="{{ route('admin.resource.bottom.mover.update',$bottomMover->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="card mt-4">
                            <div class="card-body">
                                <div class="card-head">
                                    <h2>Resoruce Bottom Mover</h2>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="heading" class="form-control" value="{{ $bottomMover->heading }}">
                                    ...
                                    <div class="col-lg-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="point_one" class="form-control"  value="{{ $bottomMover->point_one }}">
                                    ...
                                    <div class="col-lg-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="point_two" class="form-control"  value="{{ $bottomMover->point_two }}">
                                    ...
                                    <div class="col-lg-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="point_three" class="form-control"  value="{{ $bottomMover->point_three }}">
                                    ...
                                    <div class="col-lg-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="position" id="" class="form-control">
                                                <option value="{{ $bottomMover->position }}">Current: {{ $bottomMover->position }}</option>
                                                @for ($i=1 ; $i <=10 ; $i ++)
                                    ...
                                    <div class="col-lg-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="company_id" id="" class="form-control">
                                                <option value="{{ $bottomMover->company->id }}">Current: {{ $bottomMover->company->company_name }}</option>
                                    ...
                                    <div class="col-lg-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <select name="resource_page_id" id="" class="form-control">
                                                <option value="{{ $bottomMover->resourcePage->id }}">Current: {{ $bottomMover->resourcePage->title }}</option>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="content"  rows="10" cols="30" class="form-control" id="mytextarea">{{ $bottomMover->content }}</textarea>
                                        </div>
                                    </div>
                                </div>
