...
@section('title','Resource Other Mover Create')
        ...
        <div class="col-lg-12 col-ml-12">
            <div class="row">
                ...
                <div class="col-12 mt-5">
                    ...
                    <h4 class="header-title">Resource Other Mover - Create</h4>
                    @include('flash-message')
                    <form action="{{ route('admin.resource.other.mover.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card mt-4">
                            <div class="card-body">
                                <div class="card-head">
