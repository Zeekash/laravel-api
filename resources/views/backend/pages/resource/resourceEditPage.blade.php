...
@section('title','Resource Page Edit')
        ...
        <div class="col-lg-12 col-ml-12">
            <div class="row">
                ...
                <div class="col-12 mt-5">
                    ...
                    <form action="{{ route('admin.resource.update',$resourcePage->id) }}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="card mt-2">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $resourcePage->meta_title }}" name="meta_title" class="form-control">
                                    ...
                                    <div class="col-lg-8 col-12">
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Meta
                                                Description</label>
                                            <input type="text" value="{{ $resourcePage->meta_description }}" name="meta_description" class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $resourcePage->title }}" name="title" class="form-control">
                                    ...
                                    <div class="col-lg-8 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $resourcePage->slug }}" name="slug" class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="full_service_content" rows="10" cols="30" class="form-control" id="mytextarea">{{ $resourcePage->full_service_content }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            {{-- <textarea name="body" rows="10" cols="30" class="form-control" id="summernote" required></textarea> --}}
                                            <textarea name="other_service_content" rows="10" cols="30" class="form-control" id="mytextarea">{{ $resourcePage->other_service_content }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            {{-- <textarea name="body" rows="10" cols="30" class="form-control" id="summernote" required></textarea> --}}
                                            <textarea name="upper_content" rows="10" cols="30" class="form-control" id="mytextarea">{{ $resourcePage->upper_content }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Middle
                                                Content</label>
                                            {{-- <textarea name="body" rows="10" cols="30" class="form-control" id="summernote" required></textarea> --}}
                                            <textarea name="middle_content" rows="10" cols="30" class="form-control" id="mytextarea">{{ $resourcePage->middle_content }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            {{-- <textarea name="body" rows="10" cols="30" class="form-control" id="summernote" required></textarea> --}}
                                            <textarea name="bottom_content" rows="10" cols="30" class="form-control" id="mytextarea">{{ $resourcePage->bottom_content }}</textarea>
                                        </div>
                                    </div>
                                </div>
