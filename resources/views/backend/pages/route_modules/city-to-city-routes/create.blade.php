...
@section('title','City To City Route Create')
@section('styles')
        ...
        <div class="col-lg-12 col-ml-12">
            <div class="row">
                ...
                <div class="col-12 mt-5">
                    ...
                    <h4 class="header-title">City To City Route - Create</h4>
                    @include('flash-message')
                    <form action="{{ route('admin.city-to-city-routes.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{-- <div class="card mt-2">
                            <div class="card-body">
                                <div class="card-head">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <Select class="form-control select2" name="city_from_id">
                                                ...
                                                @foreach ($city_pages as $cityFrom)
                                                    <option value="{{ $cityFrom->id }}"> {{ $cityFrom->name }}, {{ $cityFrom->state->abv }}</option>
                                                @endforeach
                                            </Select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <Select class="form-control select2" name="city_to_id">
                                                ...
                                                @foreach ($city_pages as $cityTo)
                                                    <option value="{{ $cityTo->id }}"> {{ $cityTo->name }}, {{ $cityTo->state->abv }}</option>
                                                @endforeach
                                            </Select>
                                        </div>
                                    </div>
