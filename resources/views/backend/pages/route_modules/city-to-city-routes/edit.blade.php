...
@section('title','City To City Route Edit')
@section('styles')
        ...
        <div class="col-lg-12 col-ml-12">
            <div class="row">
                ...
                <div class="col-12 mt-5">
                    <a href="{{ route('admin.city-to-city-routes.index') }}" class="btn btn-primary float-right "> Back</a>
                    <h4 class="header-title">City To City Route - Edit</h4>
                    @include('flash-message')
                    <form action="{{ route('admin.city-to-city-routes.update', $cityToCityRoute->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        {{-- <div class="card mt-2">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="meta_title" value="{{ $cityToCityRoute->meta_title }}" class="form-control">
                                    ...
                                    <div class="col-lg-8 col-12">
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">Meta
                                                Description</label>
                                            <input type="text" name="meta_description" value="{{ $cityToCityRoute->meta_description }}" class="form-control">
                                ...
                                {{-- <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" value="{{ $cityToCityRoute->title }}" class="form-control">
                                    ...
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="slug" value="{{ $cityToCityRoute->slug }}" class="form-control">
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="miles" value="{{ $cityToCityRoute->miles }}" class="form-control">
                                    ...
                                    {{-- <div class="col-lg-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="min_cost" value="{{ $cityToCityRoute->min_cost }}" class="form-control">
                                    ...
                                    <div class="col-lg-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="max_cost" value="{{ $cityToCityRoute->max_cost }}" class="form-control">
                                        </div>
                                    </div> --}}
                                </div>
                                <div class="row">
                                    <div class="col-lg-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <Select class="form-control select2" name="city_from_id">
                                                <option value="" selected disabled>--- Select City From ---</option>
                                                @foreach ($city_pages as $cityFrom)
                                                    <option value="{{ $cityFrom->id }}" {{ $cityToCityRoute->city_from_id == $cityFrom->id ? 'selected' : '' }}> {{ $cityFrom->name }}, {{ $cityFrom->state->abv }}</option>
                                                @endforeach
                                            </Select>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-12">
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">City To</label>
                                            <Select class="form-control select2" name="city_to_id">
                                                <option value="" selected disabled>--- Select City To ---</option>
                                                @foreach ($city_pages as $cityTo)
                                                    <option value="{{ $cityTo->id }}" {{ $cityToCityRoute->city_to_id == $cityTo->id ? 'selected' : '' }}> {{ $cityTo->name }}, {{ $cityTo->state->abv }}</option>
                                                @endforeach
                                            </Select>
                                        </div>
                                    </div>
                                ...
                                {{-- <div class="row">
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="upper_content" rows="10" cols="30" class="form-control" id="mytextarea">{{ $cityToCityRoute->upper_content }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="middle_content" rows="10" cols="30" class="form-control" id="mytextarea">{{ $cityToCityRoute->middle_content }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="bottom_content" rows="10" cols="30" class="form-control" id="mytextarea">{{ $cityToCityRoute->bottom_content }}</textarea>
                                        </div>
                                    </div>
                                </div> --}}
