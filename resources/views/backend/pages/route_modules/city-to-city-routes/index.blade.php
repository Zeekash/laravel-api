        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    <h4 class="page-title pull-left">City To City Route</h4>
                    <ul class="breadcrumbs pull-left">
                        <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li><span>City To City Route</span></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="seo-fact sbg1">
                        <div class="p-4 d-flex justify-content-between align-items-center">
                            <div class="seofct-icon">Total City To City Routes</div>
                            <h2>{{ $routesCount }}</h2>
                        </div>
                    </div>
                </div>
            </div>
            @if ($user->can('city-to-city-route.view-trash'))
                <div class="col-md-6 col-lg-3 mt-5 mb-3">
                    <div class="card">
                        <div class="seo-fact sbg3">
                            <a href="{{ route('admin.city-to-city-routes.trashed') }}">
                                <div class="p-4 d-flex justify-content-between align-items-center">
            ...
            <div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-3">
                                <h4 class="header-title float-left">City To City Routes</h4>
                            </div>
                            <div class="col-lg-6 mt-0">

                                <form action="{{ route('admin.city-to-city-routes.import') }}" method="POST"
                            ...
                            <div class="col-lg-3">
                                @if ($user->can('city-to-city-route.create'))
                                    <p class="float-right mb-2">
                                        <a class="btn btn-primary text-white"
                                            href="{{ route('admin.city-to-city-routes.create') }}">Create
                                        </a>
                                    </p>
                                @endif
                            </div>
    ...
    <script>
        ...
        if ($('#dataTable').length) {
            $('#dataTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('admin.city-to-city-routes.index') }}',
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'DT_RowIndex',
                        orderable: false,
