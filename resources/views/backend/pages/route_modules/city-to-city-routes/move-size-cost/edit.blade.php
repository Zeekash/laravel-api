...
@section('title', 'City To City Route Move Size Cost Edit')
@section('styles')
            ...
            <div class="col-lg-12 col-ml-12">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <h4 class="header-title">City To City Route Move Size Cost - Edit</h4>
                        @include('flash-message')
                        <form action="{{ route('admin.city-to-city-routes.move-size-cost.update', $moveSizeCost->id) }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <Select class="form-control select2" name="city_to_city_route_id">
                                                    ...
                                                    @foreach ($city_to_city_routes as $cityToCityRoute)
                                                        <option value="{{ $cityToCityRoute->id }}" {{ $cityToCityRoute->id == $moveSizeCost->city_to_city_route_id ? 'selected' : '' }}>
