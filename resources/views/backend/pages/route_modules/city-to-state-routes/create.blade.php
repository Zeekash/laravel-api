...
@section('title','City To State Route Create')
@section('styles')
        ...
        <div class="col-lg-12 col-ml-12">
            <div class="row">
                ...
                <div class="col-12 mt-5">
                    ...
                    <h4 class="header-title">City To State Route - Create</h4>
                    <div class="clearfix"></div>
                    @include('flash-message')
                    <form action="{{ route('admin.city-to-state-routes.store') }}" method="POST">
                        @csrf
                        {{-- <div class="card mt-2">
                            <div class="card-body">
                                <div class="card-head">
