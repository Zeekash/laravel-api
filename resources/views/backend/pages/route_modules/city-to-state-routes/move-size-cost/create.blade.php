...
@section('title', 'City To State Route Move Size Cost Create')
@section('styles')
            ...
            <div class="col-lg-12 col-ml-12">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <a href="{{ route('admin.city-to-state-routes.move-size-cost.index') }}"
                            class="btn btn-primary float-right "> Back</a>
                        <h4 class="header-title">City To State Route Move Size Cost - Create</h4>
                        @include('flash-message')
                        <form action="{{ route('admin.city-to-state-routes.move-size-cost.store') }}" method="POST">
                            @csrf
                            <div class="card mt-4">
                                <div class="card-body">
                                    <div class="card-head">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <Select class="form-control select2" name="city_to_state_route_id">
                                                    ...
                                                    @foreach ($city_to_state_routes as $cityToStateRoute)
                                                        <option value="{{ $cityToStateRoute->id }}">
                                                            {{ $cityToStateRoute->cityFrom->name }}, {{ $cityToStateRoute->cityFrom->state->abv }} to {{ $cityToStateRoute->stateTo->name }}</option>
                                                    @endforeach
                                                </Select>
                                            </div>
                                        </div>
