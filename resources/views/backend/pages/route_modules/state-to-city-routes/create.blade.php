...
@section('title', 'State To City Route Create')
@section('styles')
                ...
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <a href="{{ route('admin.state-to-city-routes.index') }}" class="btn btn-primary float-right ">
                            Back</a>
                        <h4 class="header-title">State To City Route - Create</h4>
                        @include('flash-message')
                        <form action="{{ route('admin.state-to-city-routes.store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control stateSelect2" name="state_from_id">
                                        ...
                                        <div class="col-lg-4 col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control citySelect2" name="city_to_id">
