...
@section('title', 'State To City Route Move Size Cost Create')
@section('styles')
            ...
            <div class="col-lg-12 col-ml-12">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <h4 class="header-title">State To City Route Move Size Cost - Create</h4>
                        @include('flash-message')
                        <form action="{{ route('admin.state-to-city-routes.move-size-cost.store') }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <Select class="form-control select2" name="state_to_city_route_id">
                                                    ...
                                                    @foreach ($state_to_city_routes as $StateToCityRoute)
                                                        <option value="{{ $StateToCityRoute->id }}">
                                                            {{ $StateToCityRoute->stateFrom->name }} to {{ $StateToCityRoute->cityTo->name }}, {{ $StateToCityRoute->cityTo->state->abv }}</option>
                                                    @endforeach
                                                </Select>
                                            </div>
                                        </div>
