...
@section('title','State To State Route Create')
@section('styles')
        ...
        <div class="col-lg-12 col-ml-12">
            <div class="row">
                ...
                <div class="col-12 mt-5">
                    ...
                    <h4 class="header-title">State To State Route - Create</h4>
                    <div class="clearfix"></div>
                    @include('flash-message')
                    <form action="{{ route('admin.state-to-state-routes.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{-- <div class="card mt-2">
                            <div class="card-body">
                                <div class="card-head">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <Select class="form-control select2" name="state_from_id">
                                                ...
                                                @foreach ($states as $stateFrom)
                                                    <option value="{{ $stateFrom->id }}"> {{ $stateFrom->name }}</option>
                                                @endforeach
                                            </Select>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <Select class="form-control select2" name="state_to_id">
                                                ...
                                                @foreach ($states as $stateTo)
                                                    <option value="{{ $stateTo->id }}"> {{ $stateTo->name }}</option>
                                                @endforeach
                                            </Select>
                                        </div>
                                    </div>
