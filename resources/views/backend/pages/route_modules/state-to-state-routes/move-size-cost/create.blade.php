...
@section('title', 'State To State Route Move Size Cost Create')
@section('styles')
            ...
            <div class="col-lg-12 col-ml-12">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <h4 class="header-title">State To State Route Move Size Cost - Create</h4>
                        @include('flash-message')
                        <form action="{{ route('admin.state-to-state-routes.move-size-cost.store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4 col-12">
                                            <div class="form-group">
                                                <label for="example-text-input" class="col-form-label">State To State Route</label>
                                                <Select class="form-control select2" name="state_to_state_route_id" required>
                                                    <option value="" selected disabled>--- Select State to State Route ---</option>
                                                    @foreach ($state_to_state_routes as $stateToStateRoute)
                                                        <option value="{{ $stateToStateRoute->id }}">
                                                            {{ $stateToStateRoute->stateFrom->name }} to {{ $stateToStateRoute->stateTo->name }}</option>
                                                    @endforeach
                                                </Select>
                                            </div>
                                        </div>
