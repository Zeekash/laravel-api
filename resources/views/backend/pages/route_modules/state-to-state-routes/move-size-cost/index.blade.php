...
@section('title')
State To State Route Move Size Cost - List
@endsection
        ...
        <div class="row align-items-center">
            <div class="col-sm-6">
                <div class="breadcrumbs-area clearfix">
                    ...
                    <h4 class="page-title pull-left">State To State Move Size Cost</h4>
                    <ul class="breadcrumbs pull-left">
                        <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li><span>State To State Move Size Cost</span></li>
                    </ul>
                </div>
            </div>
    ...
    <div class="main-content-inner">
        <div class="row">
            ...
            <div class="col-12 mt-5">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title float-left">State To State Move Size Cost</h4>
                        @if ($user->can('state-to-state-route.create'))
                        <p class="float-right mb-2">
                            <a class="btn btn-primary text-white" href="{{ route('admin.state-to-state-routes.move-size-cost.create') }}">Create
                            </a>
                        </p>
                        @endif
                        ...
                        <div class="data-tables">
                            ...
                            <table id="dataTable" class="text-center table-responsive-lg">
                                <thead class="bg-light text-capitalize">
                                    <tr>
                                        <th>Sr No.</th>
                                        <th>State To State Route Page Title</th>
    ...
    <script>
        ...
        if ($('#dataTable').length) {
            $('#dataTable').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route("admin.state-to-state-routes.move-size-cost.index") }}',
                columns: [
