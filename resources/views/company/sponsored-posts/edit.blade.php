...
<div class="container-fluid" style="padding: 30px;">
    <div class="sp-container">
        ...
        <div class="sp-header">
            <h2>Edit Sponsored Blog Post</h2>
        ...
        <div class="sp-form-card">
            <form method="POST" action="{{ route('company.sponsored-posts.update', $post->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="sp-form-group">
                    ...
                    <input type="text" name="title" id="title-input" class="sp-input" placeholder="e.g. How Sarah Moved Her Family from New York to Miami — Stress-Free" maxlength="100" value="{{ old('title', $post->title) }}" required>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="sp-form-group">
                            ...
                            <textarea name="meta_description" id="meta-input" class="sp-textarea" rows="3" placeholder="Google search snippet — describe the post..." maxlength="160" required>{{ old('meta_description', $post->meta_description) }}</textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="sp-form-group">
                            ...
                            <input type="text" name="focus_keyword" class="sp-input" placeholder="e.g. New York to Miami movers" value="{{ old('focus_keyword', $post->meta_keywords) }}" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="sp-form-group h-100 mb-0 pb-4">
                            ...
                            <div class="sp-upload-box {{ $post->image ? 'has-preview' : '' }}" id="upload-box">
                                <input type="file" name="image" id="image-file-input" accept="image/*">
                                <img id="image-preview-img" src="{{ $post->image ? asset('storage/' . $post->image) : '' }}" alt="Preview" style="{{ $post->image ? 'display:block;' : '' }}">
                                <div class="preview-overlay"><i class="fa fa-edit me-1"></i> Click to change image</div>
                                <div class="sp-upload-placeholder" id="upload-placeholder" style="{{ $post->image ? 'display:none;' : '' }}">
                ...
                <button type="submit" class="sp-submit-btn">
                    <i class="fa fa-paper-plane"></i> Update Request — No Payment Now
                </button>
