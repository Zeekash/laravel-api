                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="line-height: 160%;"><span
                                                                        style="font-size: 16px; line-height: 25.6px;"><strong>Hi
                                                                            {{ $dispute->company->name }},</strong></span>
                                                                </p>
                                                                <div>
                                                                    <p style="line-height: 160%;">&nbsp;</p>
                                                                    <p style="line-height: 160%;">I hope your are doing
                                                                        well today.Thank you for reaching out, we are
                                                                        considering your request.Your ticket
                                                                        #{{ $dispute->id }}.We will let you know as
                                                                        soon as posssible after processing.<br><br></p>
                                                                </div>
                                                                <div>
                                                                    <p style="line-height: 160%;">Thank You!</p>
                                                                    <p style="line-height: 160%;">&nbsp;</p>
                                                                    <p style="line-height: 160%;"><strong>Best
                                                                            Regards,</strong></p>
                                                                    <p style="line-height: 160%;">&nbsp;</p>
                                                                </div>
                                                                <div>
                                                                    <p style="line-height: 160%;"><strong>My Moving
                                                                            Journey Team</strong></p>
                                                                    <p style="line-height: 160%;"><span
                                                                            style="line-height: 22.4px; color: #236fa1;"><strong><span
                                                                                    style="line-height: 22.4px;"><a
                                                                                        style="color: #236fa1;"
                                                                                        target="_blank"
                                                                                        href="https://mymovingjourney.com/"
                                                                                        rel="noopener">https://mymovingjourney.com</a></span></strong>
                                                                        </span>
                                                                    </p>
                                                                    <p style="line-height: 160%;">&nbsp;</p>
                                                                    <p style="line-height: 160%;">&nbsp;</p>
                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 14px; line-height: 180%;"><span
                                                                        style="font-size: 16px; line-height: 28.8px;">&nbsp;Copyright
