														...
														<tr>
															<td class="pad"
																...
																<h1
																	...
																	<span class="tinyMce-placeholder">New Company
																		Registered</span></h1>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad">
																<div
																	...
																	<p style="margin: 0;">New Company Has Been
																		Registered to your website.</p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad">
																<div
																	...
																	<p style="margin: 0;">Owner Name : <span
																			style="color: #123269;">{{$company->name}}</span></p>
																</div>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#101112;font-size:18px;font-family:'Nunito', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-weight:700;line-height:180%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:32.4px;">
																	<p style="margin: 0;">Company Name  : <span
																			style="color: #123269;">{{$company->company_name}}</span></p>
																</div>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#101112;font-size:18px;font-family:'Nunito', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-weight:700;line-height:180%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:32.4px;">
																	<p style="margin: 0;">Owner Email : <span
																			style="color: #123269;">{{$company->email}}</span>
																	</p>
																</div>
															</td>
														</tr>
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#101112;font-size:18px;font-family:'Nunito', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-weight:700;line-height:180%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:32.4px;">
																	<p style="margin: 0;">Company Email : <span
																			style="color: #123269;">{{$company->company_email}}</span>
																	</p>
																</div>
															</td>
														</tr>
															...
															<td class="pad">
																<div
																	...
																	<p style="margin: 0;">State : <span
																			style="color: #123269;">{{$company->state->name}}</span></p>
																</div>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#101112;font-size:18px;font-family:'Nunito', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-weight:700;line-height:180%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:32.4px;">
																	<p style="margin: 0;">Contact Number : <span
																			style="color: #123269;">{{$company->phone_no}}</span>
																	</p>
																</div>
															</td>
														</tr>
