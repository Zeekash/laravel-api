    ...
    <tbody>
      <tr style="vertical-align: top">
        <td style="word-break: break-word;border-collapse: collapse !important;vertical-align: top">
                  ...
                  <div style="height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                    ...
                    <div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                      ...
                      <table id="u_content_image_2" style="font-family:'Rubik',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 0px;font-family:'Rubik',sans-serif;" align="left">

                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">

                                    <img align="center" border="0" src="https://mymovingjourney.com/assets/img/logo.png" alt="Hero Image" title="Hero Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 66%;max-width: 396px;"
                                      width="396" class="v-src-width v-src-max-width" />
                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="https://assets.unlayer.com/projects/150846/1680602047546-5599.jpg" alt="" title="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 40%;max-width: 240px;"
                                      width="240" class="v-src-width v-src-max-width" />
          ...
          <div class="u-row-container" style="padding: 0px;background-color: transparent">
            <div class="u-row" style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #203569;">
              <div style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: #203569;"><![endif]-->
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:20px 25px;font-family:'Rubik',sans-serif;" align="left">
                              ...
                              <h1 class="v-text-align v-font-size" style="margin: 0px; color: #ecf0f1; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Raleway',sans-serif; font-size: 30px; "><strong>Review Deleted!</strong></h1>
                  ...
                  <div style="height: 100%;width: 100% !important;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                    ...
                    <div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 1px solid #CCC;border-left: 1px solid #CCC;border-right: 1px solid #CCC;border-bottom: 1px solid #CCC;border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px;">
                      ...
                      <table id="u_content_text_2" style="font-family:'Rubik',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:22px 50px 20px;font-family:'Rubik',sans-serif;" align="left">

                              <div class="v-text-align v-font-size" style="color: #5c5c5c; line-height: 150%; text-align: left; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 150%;"><span style="font-size: 16px; line-height: 24px;"><strong>Hi {{$user->company->name}}, </strong></span></p>
                                <p style="font-size: 14px; line-height: 150%;"> </p>
                                <p style="font-size: 14px; line-height: 150%;"><span style="font-size: 16px; line-height: 24px;">User Has Deleted Review From Your Company.</span></p>
                                <p style="font-size: 14px; line-height: 150%;"> </p>
                                <p style="font-size: 14px; line-height: 150%;"><span style="text-decoration: underline; line-height: 21px;"><span style="font-size: 16px; line-height: 24px;"><strong>DETAILS:</strong></span></span>
                                </p>
                                <p style="line-height: 150%;"><strong>User Name: </strong>{{$user->name}}</p>
                                <p style="line-height: 150%;"><strong>User Email: </strong>{{$user->email}}</p>
                                <p style="line-height: 150%;"><strong>Rating: </strong>{{$user->overall_rating}}</p>
                                <p style="line-height: 150%;"><strong>Review Subject: </strong>{{$user->review_subject}}</p>
                                <p style="line-height: 150%;"><strong>Review: </strong>{{$user->your_review}}</p>
                                <p style="line-height: 150%;"><strong>Service Cost: </strong>{{$user->service_cost}}</p>
                                <p style="line-height: 150%;"><strong>Move Type: </strong>{{$user->move_type}}</p>
                                <p style="line-height: 150%;"><strong>Move Size: </strong>{{$user->move_size}}</p>
                                <p style="line-height: 150%;"><strong>Pick-up State: </strong>{{$user->pickState->name}}</p>
                                <p style="line-height: 150%;"><strong>Pick-up City: </strong>{{$user->pickCity->name}}</p>
                                <p style="line-height: 150%;"><strong>Delivery State: </strong>{{$user->deliveryState->name}}</p>
                                <p style="line-height: 150%;"><strong>Delivery City: </strong>{{$user->deliveryCity->name}}</p>
                                <p style="line-height: 150%;"> </p>
                                <p style="line-height: 150%;">Best regards,</p>
                                <p style="line-height: 150%;"><strong>My Moving Journey Team</strong></p>
                              </div>
          ...
          <div class="u-row-container" style="padding: 0px;background-color: transparent">
            <div class="u-row" style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: #d91f25;">
              <div style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
                <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: transparent;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: #d91f25;"><![endif]-->
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 44px 35px;font-family:'Rubik',sans-serif;" align="left">
                              ...
                              <div class="v-text-align v-font-size" style="color: #ffffff; line-height: 100%; text-align: center; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 100%;"> </p>
                                <p style="font-size: 14px; line-height: 100%;">© 2023 <span style="color: #ffffff; line-height: 14px;"><a rel="noopener" href="https://mymovingjourney.com/" target="_blank" style="color: #ffffff;">My Moving Journey</a></span> All rights reserved.</p>
                              </div>
