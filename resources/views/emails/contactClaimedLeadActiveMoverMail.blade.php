{{-- <p>
    you got the new lead. check your dashboard.
</p> --}}
...
<div dir="ltr">
    ...
    <font face="verdana, sans-serif">
        {{-- <img src="{{ asset('assets/image/bell.png') }}" alt="72.png" width="45"
            height="45" style="margin-right: 0px" data-image-whitelisted="" class="CToWUd" data-bit="iit" /> --}}
        &nbsp;
        <font size="4"><b>{{ $contactMover->name }}</b>&nbsp; has choosen your company for Moving.<br /></font>

        <br />
    </font>
    <div>
        <font face="verdana, sans-serif"><b>Zip From:</b>&nbsp;{{ $contactMover->zip_from }}<br /></font>
    </div>
    <div>
        <font face="verdana, sans-serif"><b>Email</b>: {{ $contactMover->email }}<br /><b>Phone</b>:
            {{ $contactMover->phone_no }}</font>
    </div>
    <div>
        <font face="verdana, sans-serif"><br /></font>
    </div>
    ...
    <div>
        <font face="verdana, sans-serif">
            Thank you for choosing <a href="https://mymovingjourney.com/">My Moving Journey</a>. We look forward to
            providing
            ...
            <br>
            <br>
            {{-- <img src="{{ asset('assets/image/logo/MGM-LOGO.png') }}" alt="logo" width="15%"> --}}
        </font>
    ...
    you with an exceptional experience and are committed to serving your business needs. If you have any queries,
    contact us at <a href="mailto:inquiry@mygoodmovers.com">inquiry@mygoodmovers.com</a>.
    <br>
    <br>
    Best Regards,
    <br>
