														...
														<tr>
															<td class="pad"
																...
																<h1
																	...
																	<span class="tinyMce-placeholder">Thank You For Submitting Your Cost Estimate</span></h1>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	...
																	<p style="margin: 0;">Details Are Down Below:</p>
																</div>
															</td>
														</tr>
													</table>
															...
															<td class="pad">
																<div
																	...
																	<p style="margin: 0;">Name : <span
																			style="color: #123269;">{{$cost_estimator->name}}</span></p>
																</div>
															</td>
														</tr>
													</table>
															...
															<td class="pad">
																<div
																	...
																	<p style="margin: 0;">Email  : <span
																			style="color: #123269;">{{$cost_estimator->email}}</span></p>
																</div>
															</td>
														</tr>
													</table>
															...
															<td class="pad">
																<div
																	...
																	<p style="margin: 0;">Phone No. : <span
																			style="color: #123269;">{{$cost_estimator->phone_no}}</span>
																	</p>
																</div>
															</td>
														</tr>
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#101112;font-size:18px;font-family:'Nunito', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-weight:700;line-height:180%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:32.4px;">
																	<p style="margin: 0;">Zip From : <span
																			style="color: #123269;">{{$cost_estimator->zip_from}}</span>
																	</p>
																</div>
															</td>
														</tr>
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#101112;font-size:18px;font-family:'Nunito', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-weight:700;line-height:180%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:32.4px;">
																	<p style="margin: 0;">Zip To : <span
																			style="color: #123269;">{{$cost_estimator->zip_to}}</span></p>
																</div>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#101112;font-size:18px;font-family:'Nunito', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-weight:700;line-height:180%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:32.4px;">
																	<p style="margin: 0;">Move Size : <span
																			style="color: #123269;">{{$cost_estimator->move_size}}</span></p>
																</div>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#101112;font-size:18px;font-family:'Nunito', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-weight:700;line-height:180%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:32.4px;">
																	<p style="margin: 0;">Move Date : <span
																			style="color: #123269;">{{$cost_estimator->date}}</span></p>
																</div>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#101112;font-size:18px;font-family:'Nunito', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-weight:700;line-height:180%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:32.4px;">
																	<p style="margin: 0;">Move Distance : <span
																			style="color: #123269;">{{$cost_estimator->distance}}</span></p>
																</div>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#101112;font-size:18px;font-family:'Nunito', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-weight:700;line-height:180%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:32.4px;">
																	<p style="margin: 0;">Move Min Price : <span
																			style="color: #123269;">${{$cost_estimator->min_price}}</span></p>
																</div>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	style="color:#101112;font-size:18px;font-family:'Nunito', Arial, 'Helvetica Neue', Helvetica, sans-serif;font-weight:700;line-height:180%;text-align:left;direction:ltr;letter-spacing:0px;mso-line-height-alt:32.4px;">
																	<p style="margin: 0;">Move Max Pice : <span
																			style="color: #123269;">${{$cost_estimator->max_price}}</span></p>
																</div>
															</td>
														</tr>
													</table>
