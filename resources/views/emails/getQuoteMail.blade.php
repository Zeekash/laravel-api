														...
														<tr>
															<td class="pad"
																...
																<h1
																	...
																	<span class="tinyMce-placeholder">Thank You For Submitting Your Quotation</span></h1>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad">
																<div
																	...
																	<p style="margin: 0;">Your Quotation Details Are Down Below:</p>
																</div>
															</td>
														</tr>
													</table>
															...
															<td class="pad">
																<div
																	...
																	<p style="margin: 0;">Name : <span
																			style="color: #123269;">{{$get_quote->name}}</span></p>
																</div>
															</td>
														</tr>
													</table>
															...
															<td class="pad">
																<div
																	...
																	<p style="margin: 0;">Email  : <span
																			style="color: #123269;">{{$get_quote->email}}</span></p>
																</div>
															</td>
														</tr>
													</table>
															...
															<td class="pad">
																<div
																	...
																	<p style="margin: 0;">Phone No. : <span
																			style="color: #123269;">{{$get_quote->phone_no}}</span>
																	</p>
																</div>
															</td>
														</tr>
															...
															<td class="pad">
																<div
																	...
																	<p style="margin: 0;">Zip From : <span
																			style="color: #123269;">{{$get_quote->zip_from}}</span>
																	</p>
																</div>
															</td>
														</tr>
															...
															<td class="pad">
																<div
																	...
																	<p style="margin: 0;">Zip To : <span
																			style="color: #123269;">{{$get_quote->zip_to}}</span>
																	</p>
																</div>
															</td>
														</tr>
															...
															<td class="pad">
																<div
																	...
																	<p style="margin: 0;">Move Size : <span
																			style="color: #123269;">{{$get_quote->move_size}}</span>
																	</p>
																</div>
															</td>
														</tr>
															...
															<td class="pad">
																<div
																	...
																	<p style="margin: 0;">Date : <span
																			style="color: #123269;">{{$get_quote->date}}</span>
																	</p>
																</div>
															</td>
														</tr>
