                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                  <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
                                    ...
                                    <img align="center" border="0" src="https://assets.unlayer.com/projects/150846/1680554396336-5598.jpg" alt="" title="" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 43%;max-width: 258px;"
                                      width="258" class="v-src-width v-src-max-width" />
                        ...
                        <tbody>
                          <tr>
                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:20px 25px;font-family:'Rubik',sans-serif;" align="left">
                              ...
                              <h1 class="v-text-align v-font-size" style="margin: 0px; color: #ecf0f1; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Raleway',sans-serif; font-size: 27px; ">Moving Review deactivated!</h1>
                          ...
                          <tr>
                            <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:22px 50px 20px;font-family:'Rubik',sans-serif;" align="left">
                              ...
                              <div class="v-text-align v-font-size" style="color: #5c5c5c; line-height: 150%; text-align: left; word-wrap: break-word;">
                                <p style="font-size: 14px; line-height: 150%;"><span style="font-size: 16px; line-height: 24px;"><strong>Hi {{$user->name}}, </strong></span></p>
                                <p style="font-size: 14px; line-height: 150%;"> </p>
                                <p style="font-size: 14px; line-height: 150%;"><span style="font-size: 16px; line-height: 24px;">We wanted to inform you that the review you had previously left on My Moving Journey has been successfully deleted. We understand that you no longer want to share your review with the public.  </span></p>
                                <p style="font-size: 14px; line-height: 150%;"> </p>
                                <p style="font-size: 14px; line-height: 150%;"><span style="font-size: 16px; line-height: 24px;">Thank you for your previous review and your contribution to our website.</span></p>
                                <p style="font-size: 14px; line-height: 150%;"> </p>
                                <p style="line-height: 150%;"><span style="font-size: 16px; line-height: 24px;">We would also like to invite you to leave another review anytime you want. We hope that you continue to write about your moving experiences on My Moving Journey.</span></p>
