...
<head>
    <meta charset="UTF-8">
    <title>New Sponsored Post Request</title>
    <style>
...
<body>
    <div class="container">
        <h1>New Sponsored Post Request</h1>
        <p>Hello Admin,</p>
        <p>A company has submitted a new sponsored post request that requires your review.</p>
        ...
        <div class="details">
            ...
            <p><strong>Submitted On:</strong> {{ $post->created_at->format('M d, Y') }}</p>
        </div>
