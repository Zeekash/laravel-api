...
<head>
    <meta charset="UTF-8">
    <title>Sponsored Post Resubmitted Successfully</title>
    <style>
...
<body>
    <div class="container">
        <h1>Post Resubmitted Successfully</h1>
        <p>Hello {{ $post->company->company_name ?? 'Company' }},</p>
        <p>Your sponsored post request has been successfully updated and resubmitted to our administration team for review.</p>
