                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            <form action="{{ route('register.post') }}" method="POST" enctype="multipart/form-data"
                                ...
                                <div class="form-outline mb-2">
                                        ...
                                        <div class="col-12 col-sm-6 col-md-6 p-0  pe-sm-3 mt-2">
                                            <div class="input-group my-2">
                                                <input required type="email"
                                                    class="form-control @error('email') is-invalid @enderror di"
                                    ...
                                    <div class="row m-auto w-100">
                                        <div class="col-12 col-sm-6 p-0 pe-sm-3 mt-2">
                                            <div class="input-group my-2">
                                                <input required type="password"
                                                    class="border-end-0 no-right-radius form-control di @error('password') is-invalid @enderror"
                                                    name="password" id="password" placeholder="Password"
                                                    aria-label="password" value="{{ old('password') }}"
                                                    aria-describedby="basic-addon1">
                                                <span class="input-group-text di" onclick="password_show_hide();">
                                                    <i class="fas fa-eye" id="show_eye"
                                                        style="color: rgb(37 113 128);"></i>
                                        ...
                                        <div class="col-12 col-sm-6 p-0 pe-sm-2 mt-2">
                                            <div class="input-group my-2">
                                                <input required type="password"
                                                    class="border-end-0 no-right-radius form-control  di @error('password_confirmation') is-invalid @enderror"
                                                    name="password_confirmation" id="password_confirmation"
                                                    value="{{ old('password_confirmation') }}"
                                                    placeholder="Confirm Password" aria-label="password"
                                                    aria-describedby="basic-addon1">
                                                <span class="input-group-text di"
                                                    onclick="password_confirmation_show_hide();">
                                                    <i class="fas fa-eye" id="password_confirmation_show_eye"
                                                        style="color: #116087;"></i>
                                                    <i class="fas fa-eye-slash d-none" id="password_confirmation_hide_eye"
                                                        style="color: #116087;"></i>
                                                </span>
                                ...
                                <div class="form-outline mb-2">
                                    <div class="row m-auto w-100">
                                        ...
                                        <div class="col-12 col-sm-12 col-md-6 p-0 pe-sm-3 mt-2">
                                            <div class="input-group my-2">
                                                <input type="number"
                                                    class="form-control di @error('trucks') is-invalid @enderror"
                                                    name="trucks" value="{{ old('trucks') }}"
                                        ...
                                        <div class="col-12 col-sm-12 col-md-6 p-0 pe-sm-3 mt-2">
                                            <div class="input-group my-2">
                                                <input type="number"
                                                    class="form-control di @error('founding_year') is-invalid @enderror"
                                        ...
                                        <div class="col-12 col-sm-12 col-md-12 p-0 pe-sm-3 mt-2">
                                            <div class="input-group my-2">
                                                <input required type="file"
                                                    class="form-control di @error('image') is-invalid @enderror"
                                                    name="image" value="{{ old('image') }}" id="logo" accept=".png,.webp,.svg" required>
                                        ...
                                        <div class="col-12 col-sm-12 col-md-12 p-0 pe-sm-3 mt-2">
                                            <div class="input-group my-2">
                                                <textarea name="about_company" class="form-control" cols="30" rows="10" onkeyup="CharacterCount1(this);"
                                                    placeholder="Tell us About Your Company">{{ old('about_company') }}</textarea>

                                                </div>
                                                <div id="charCountVal1" align="right">0 characters (min:600)</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-sm-6 p-0 pe-sm-3 mt-2">
                                    <div class="input-group my-2">
                                        <input required type="password"
                                            ...
                                            value="{{ old('password') }}" aria-describedby="basic-addon1">
                                        <span class="input-group-text di" onclick="password_show_hide();">
                                            <i class="fas fa-eye" id="show_eye" style="color: rgb(37 113 128);"></i>
                                            <i class="fas fa-eye-slash d-none" id="hide_eye"
                                                style="color: rgb(37 113 128);"></i>
                                        </span>
                                        @error('password')
                                ...
                                <div class="col-12 col-sm-6 p-0 ps-sm-2 mt-2">
                                    <div class="input-group my-2">
                                        <input required type="password"
                                            class="border-end-0 no-right-radius form-control di @error('password_confirmation') is-invalid @enderror"
                                            name="password_confirmation" id="password_confirmation"
                                        ...
                                        <span class="input-group-text di" onclick="password_confirmation_show_hide();">
                                            <i class="fas fa-eye" id="password_confirmation_show_eye"
                                                style="color: #116087;"></i>
                                            <i class="fas fa-eye-slash d-none" id="password_confirmation_hide_eye"
                                                style="color: #116087;"></i>
                                    ...
                                    <div class="form-outline mb-2">
                                        {{-- <div class="row m-auto w-100">
                                            ...
                                            <div class="col-12 col-sm-12 col-md-6 px-0 px-md-2 mt-2">
                                                <div class="input-group my-2">
                                                    <input type="text" id="additional_phone_no" maxlength="15"
                                                        class="form-control di @error('additional_phone_no') is-invalid @enderror"
                                                        name="additional_phone_no"
                                                        value="{{ old('additional_phone_no') }}"
                                                        placeholder="Additional Phone No. (Optional) (xxx-xxx-xxxx)">
                                        ...
                                        {{-- <div class="col-12 col-sm-12 col-md-4 px-0 ps-md-2 mt-2">
                                        <div class="input-group my-2">
                                            <input type="number"
                                                class="form-control di @error('us_dot_no') is-invalid @enderror"
                                                name="us_dot_no" value="{{ old('us_dot_no') }}"
                                                placeholder="D.O.T No.  (Optional)">
                                            @error('us_dot_no')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                {{-- <div class="form-outline mb-2">
                                <div class="row m-auto w-100">
                                    <div class="col-12 col-sm-6 col-md-6 p-0 mt-2">
                                        <div class="input-group my-2">
                                            <input required type="url"
                                                class="form-control di  @error('company_website') is-invalid @enderror"
                                                name="company_website" value="{{ old('company_website') }}"
                                    ...
                                    <div class="col-12 col-sm-6 col-md-6 p-0 ps-sm-3 mt-2">
                                        <div class="input-group my-2">
                                            <input required type="file"
                                                class="form-control di @error('image') is-invalid @enderror"
                                                name="image" value="{{ old('image') }}" id="logo" required>
                                            <span id='logoPath' class="form-control w-100"></span>
                                            <label id='buttonFile' for="logo"
                                            class="d-flex justify-content-center align-items-center form-control w-auto">Company
                                            Logo</label>
                                            @error('image')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong class="text-danger">The company logo is required.</strong>
                                                </span>
                                            @enderror
                                        </div>
                                    </div>
                                ...
                                <div class="form-outline mb-2">
                                    ...
                                    <div class="row m-auto w-100">
                                        ...
                                        <div class="col-12 col-sm-12 col-md-4 px-0 pe-md-2 mt-3">
                                            <div class="form-control di">
                                                United States
                                            </div>
                                        ...
                                        {{-- <div class="col-12 col-sm-12 col-md-4 px-0 pe-md-2 mt-3">
                                            <div class="input-group my-0">
                                                <select required id="company_country" name="country_id"
                                        ...
                                        <div class="col-12 col-sm-12 col-md-4 px-0 px-md-2 mt-3">
                                            <div class="input-group select_two my-0">
                                                <select required id="state_id" name="state_id"
                                                    class="state form-select my-2 @error('state_id') is-invalid @enderror">
                                                ...
                                                @error('state_id')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>The comapny state is required.</strong>
                                                    </span>
                                                @enderror
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-12 col-md-4 px-0 ps-md-2 mt-3">
                                            <div class="input-group select_two my-0">
                                                <select required id="city_id" name="city_id"
                                                    class="city form-select  my-2  @error('city_id') is-invalid @enderror">
                                                    <option value="">-- Select City --</option>
                                                </select>
                                                @error('city_id')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>The comapny city is required.</strong>
                                                    </span>
                                                @enderror
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6 col-md-4 px-0 pe-sm-3 mt-2">
                                            <div class="input-group my-2">
                                                <input required type="text"
                                                    class="form-control di @error('street') is-invalid @enderror"
                                                    name="street" value="{{ old('street') }}"
                                                    placeholder="Street Address">
                                                @error('street')
                                                    <span class="invalid-feedback" role="alert">
                                                        <strong>The company street is required.</strong>
                                                    </span>
                                                @enderror
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6 col-md-8 px-0 pe-sm-3 mt-2">
                                            <div class="input-group my-2">
                                                <input required type="text"
                                ...
                                <div class="form-outline mb-2">
                                    <div class="row m-auto w-100">
                                        <div class="form-title mt-3 ps-0">
                                            Service Options <span style="color:red"> *</span>
                                        </div>
                                        ...
                                        <div class="d-flex flex-wrap gap-3 mt-2">
                                            <div class="d-flex">
                                                ...
                                                <input required aria-label="terms" type="checkbox" name="allow"
                                                    value="1">
                                                <span class="ms-2">Terms of
                                                    service</span>
                                            </div>
                                        </div>
                                        {{-- <div class="col-12 col-sm-6 p-0 pe-sm-3 mt-2">
                                    <div class="input-group my-2">
                                        ...
                                        <span class="input-group-text" onclick="password_show_hide();">
                                            <i class="fas fa-eye" id="show_eye"
                                                style="color: rgb(37 113 128);"></i>
                                            <i class="fas fa-eye-slash d-none" id="hide_eye" style="color: rgb(37 113 128);"></i>
                                        </span>
                                        @error('password')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
