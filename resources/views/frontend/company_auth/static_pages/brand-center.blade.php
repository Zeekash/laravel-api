                        ...
                        <div class="row p-0 m-auto">
                                            ...
                                            <div class="row p-0 m-auto">
                                                <div class="single-footer-widget mh-100 mt-md-0 mt-3 bg-of-aqua-shade">
                                                    ...
                                                    <ul class=" quick-links">
                                                        ...
                                                        <li class="list-unstyled py-2 li-dash-comp px-xl-0 pe-5 ">
                                                            <a class="fw-normal static-page-anchors active" href="{{route('brand-center')}}">Brand center</a>
                                                        </li>
                                                    </ul>
                                                    <div class="logo">
                            ...
                            <div class="col-12 col-lg-9 col-xl-9 py-3 dash-col2  bg-of-aqua-shade border-0">
                                <section class="section about-section gray-bg" id="about-dash">
                                    <div class="container">
                                        <div class="row">
                                            <h2 class="my-2 fw-normal">Brand Center</h2>
                                            <p class="fs-5">With millions of users visiting our websites per year, our network is among the most popular moving company directories in the world. We have built a strong brand trust and you can link to our site, using our logo. Show the world that you are a part of the most trusted mover community in the world.</p>
                                            <img src="https://mymovingjourney.com//img/biz-images/Showcase-Devices-Presentation-mmr-registered.png" class="w-100">
                                            <h2 class="my-2 fw-normal">Using our logo</h2>
                                            <p class="fs-5">It is very easy to link to our website. Just choose the right size, copy the code below the photo and paste it exactly where you need it or download it from the link below.</p>
                                        </div>
                                    </div>
                                </section>
                            </div>
