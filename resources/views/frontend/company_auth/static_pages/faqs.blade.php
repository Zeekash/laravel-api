                                            ...
                                            <div class="row p-0 m-auto">
                                                <div class="single-footer-widget mh-100 mt-md-0 mt-3 bg-of-aqua-shade">
                                                    ...
                                                    <ul class=" quick-links">
                                                        ...
                                                        <li class="list-unstyled py-2 li-dash-comp px-xl-0 pe-5 ">
                                                            <a class="fw-normal static-page-anchors active" href="{{route('faqs')}}">Frequently Asked Questions</a>
                                                        </li>
                                                        <li class="list-unstyled py-2 li-dash-comp px-xl-0 pe-5 ">
                                ...
                                <section class="section about-section gray-bg" id="about-dash">
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <ul class="ps-4 my-3">
                                                <li class="my-2">
                                                    <a href="#" class="fs-5">How can I advertise with MyMovingJourney? What advertising options do you offer?</a>
                                                </li>
                                                <li class="my-2">
                                                    <a href="#" class="fs-5">Do you offer moving leads?</a>
                                                </li>
                                                <li class="my-2">
                                                    <a href="#" class="fs-5">How to become a registered mover? Is it free?</a>
                                                </li>
                                                <li class="my-2">
                                                    <a href="#" class="fs-5">I am a registered mover. How can I place the registered mover badge on my website?</a>
                                                </li>
                                                <li class="my-2">
                                                    <a href="#" class="fs-5">I  cannot access my account. How can I reset my password?</a>
                                                </li>
                                                <li class="my-2">
                                                    <a href="#" class="fs-5">I forgot my company registration email address?</a>
                                                </li>
                                                <li class="my-2">
